...
对齐 Qwen3-TTS-12Hz-0.6B 结构：冻结公开 text embedding / projector，从 Qwen3-0.6B-Base 初始化 Talker，复用官方 codec 和 ECAPA，训练新的音频预测模块。
...
python scripts/assemble_qwen3_tts.py --output pretrained/assembled-qwen3-tts-official-frozen
